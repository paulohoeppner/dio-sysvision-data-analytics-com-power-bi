...
Esse repositório corresponde ao projeto "Criando Relatórios Dinâmicos com o uso de Parâmetros no Power BI" da [DIO - Digital Innovation One](https://www.dio.me/).
<hr>

## Objetivo

Utiliza-se o relatório do desafio do módulo anterior. Com esse contexto em mãos, foi criado visuais considerando a criação de parâmetros.
