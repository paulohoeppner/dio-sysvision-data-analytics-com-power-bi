...
Esse repositório corresponde ao projeto "Criando um Dashboard Gerencial para Tomada de Decisões Com Power BI" da [DIO - Digital Innovation One](https://www.dio.me/).
<hr>

## Objetivo

Modificação do relatório criativo, focando na experiência do usuário. 
...
- Relatório é composto por 3 páginas.
